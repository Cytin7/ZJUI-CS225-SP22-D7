...
int main()
{
    ...
    do
    {
        do
        {
            ...
            cout << "10: equal\n";
            cout << "11: display\n";
            //test the final operation of delete_last
            cout << "12: delete_last\n";
            cin >> op ;
        }
        while ((op < 0) && (op > 12));
        switch(op)
        {
            ...
            case 12:{
                cout << "Please tell me how many elements does you want to delete\n";
                int k;
                cin >> k;
                while (k > mylist1.getlength()){
                    cout << "The value is larger than de length of the list!\n";
                    cout << "Please tell me how many elements does you want to delete\n";
                    cin >> k;
                }
                if (type == 0){
                    mylist1.delete_last(k);
                    cout << "the alter length is " << mylist1.getlength() << std::endl;
                }
                if (type == 1){
                    mylist2.delete_last(k);
                    cout << "the alter length is " << mylist2.getlength() << std::endl;
                }
                break;
            }
            default: return(0);
